"""
Train Stage 2 CodeT5p-770m Multi-class Classifier

This script trains a CodeT5p-770m (738M total) based classifier for AI family detection.
Uses Salesforce/codet5p-770m - a larger variant than the default 220M model.

Key differences from 220m version:
- Model: Salesforce/codet5p-770m (738M total vs 220M)
- Embedding: 1024-dim (vs 768-dim for 220M)
- Saves to: models/stage2_codet5p_770m/ (preserves existing models)
- Batch size: Adjusted for larger model (default 64)

Usage:
    # With default settings
    uv run python src/training/train_stage2_codet5p_770m.py

    # With custom batch size for larger GPU
    uv run python src/training/train_stage2_codet5p_770m.py --batch-size 128

    # For smaller GPU (16GB VRAM)
    uv run python src/training/train_stage2_codet5p_770m.py --batch-size 32
"""
...
def train_stage2_codet5p_770m(
    ...
    """
    Train Stage 2 CodeT5p-770m classifier
    ...
    """
    print("\n" + "="*80)
    print("TRAINING STAGE 2: CodeT5p-770m Multi-class Classifier")
    print("="*80 + "\n")

    import sys
    print(f"Configuration:")
    print(f"  Model: Salesforce/codet5p-770m (738M total, 335M encoder)")
    ...
    print(f"  Save directory: {models_dir}/stage2_codet5p_770m/")
    print()
    sys.stdout.flush()
    ...
    # ================================================================
    # STEP 4: Initialize CodeT5p-770m Classifier
    # ================================================================
    print("\n" + "="*80)
    print("STEP 4: Initializing CodeT5p-770m Classifier")
    print("="*80 + "\n")
    sys.stdout.flush()

    clf = Stage2CodeT5p770m(
        model_name='Salesforce/codet5p-770m',  # 738M total (335M encoder)
    ...
    print(f"  ✓ CodeT5p-770m classifier initialized")
    ...
    # ================================================================
    print("="*80)
    print("STEP 5: Training CodeT5p-770m Classifier")
    print("="*80 + "\n")
    ...
    save_dir = Path(models_dir) / 'stage2_codet5p_770m'
    ...
    print("="*80)
    print(f"Model: CodeT5p-770m (Salesforce/codet5p-770m, 738M total)")
    ...
    print("✓ Stage 2 CodeT5p-770m training complete!")
    print(f"\nNext steps:")
    print(f"  1. Evaluate full pipeline: uv run python src/evaluation/evaluate_pipeline_codet5.py --stage2-dir stage2_codet5p_770m")
    print(f"  2. Compare with 220m version: Check models/stage2_codet5/ vs models/stage2_codet5p_770m/")
    print()
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Train Stage 2 CodeT5p-770m Multi-class Classifier',
...
Examples:
  ...
  uv run python src/training/train_stage2_codet5p_770m.py --learning-rate 1e-4

  # More epochs
  uv run python src/training/train_stage2_codet5p_770m.py --max-epochs 10
        """
    )
